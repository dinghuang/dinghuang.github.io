...
### 2.17 前端相关
 ...
 6. [Angular：Angular使开发人员能够构建在Web，移动设备或桌面上的应用程序。][76]
 7. [G6：阿里蚂蚁金服出品的JavaScript中的图形可视化框架。][77]
 8. [lodash：前端JavaScript工具库，提供多种数组、字符串处理工具。][78]
 9. [Mobx：Mobx 是一个功能强大，上手非常容易的状态管理工具。][159]
 10. [Redux：也是一个状态管理工具，比Mobx更加严谨，但是上手更难。][160]
 11. [jsTree：jsTree是一个基于jQuery的Tree控件。支持XML，JSON，Html三种数据源。提供创建，重命名，移动，删除，拖放节点操作。][165]
...
### 2.19 数据库相关
 ...
 5. [PostgreSQL：自从MySQL被Oracle收购以后，PostgreSQL逐渐成为开源关系型数据库的首选。][185]
 6. [Liquibase：一个用于跟踪、管理和应用数据库变化的开源的数据库重构工具。支持xml，groovy编写。][91]
 7. [Flyway：是一个敏捷工具，用于数据库的移植。][92]
 8. [Apache Impala：是一个高性能分析数据库，可针对存储在 Apache Hadoop集群中的PB级数据进行闪电般快速的分布式 SQL查询。][93]
 9. [MyFlash：美团点评的开源MySQL闪回工具。][94]
 10. [H2 DataBase：内存数据库，可以用于单元测试中的数据库。][95]
 11. [Ctrip DAL：是携程框架部开发的数据库访问框架，支持代码生成和水平扩展。][96]
